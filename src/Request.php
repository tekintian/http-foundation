...
namespace Tekintian\HttpFoundation;

use Tekintian\HttpFoundation\Exception\ConflictingHeadersException;
use Tekintian\HttpFoundation\Exception\SuspiciousOperationException;
use Tekintian\HttpFoundation\Session\SessionInterface;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Tekintian\HttpFoundation\Request.');
            }
